...
class KdpwAktualnosci:
    ...
    def scrap():
        end_of_page = 1
        output_string = []
        path_to_file = str(Path(Path.cwd())) + "\last_announcements\last_kdpw_aktualnosci.txt"
        ...
        announcements = doc.find("ul", {"class": "dfwp-column dfwp-list"})
        ogloszenia = announcements.find_all("div", {"class": "Title"})
        for ogloszenie in ogloszenia:
            ...
            link = "http://www.kdpw.pl" + hrief['href']
