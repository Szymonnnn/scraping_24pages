...
class RfGov:
    ...
    def scrap():
        end_of_page = 1
        output_string = []
        path_to_file = str(Path(Path.cwd())) + "\last_announcements\last_rf_gov.txt"
        url = "https://rf.gov.pl/"
        ...
        announcements = doc.find("ul", {"class": "wp-block-latest-posts__list is-grid columns-3 has-dates alignwide wp-block-latest-posts"})
