...
class KomunikacjaKomunikaty:
    ...
    def scrap():
        end_of_page = 1
        output_string = []
        path_to_file = str(Path(Path.cwd())) + "\last_announcements\last_komunikacja_komunikaty.txt"
        url = "https://www.knf.gov.pl/komunikacja/komunikaty"
...
if __name__ == '__main__':
    obj = KomunikacjaKomunikaty()
    output = KomunikacjaKomunikaty.scrap()
    print(output)